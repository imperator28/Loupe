...
| 4 | Deliver the 2D Drawing Export workspace (true 1:1 DXF/SVG/PDF) and the rotating 3D view cube | [2D Drawing Export](2026-07-24-2d-drawing-export.md) | Phase 3 release gate and the W1–W8 UI refresh |
...
4. CAD work remains asynchronous and UI performance is measured against the Indigo Precision budgets.
